...
<head>
    ...
    <title><?= html_escape($article['title']); ?> - Digital Pencak Silat News</title>
...
<body>
    ...
    <header class="article-header">
        <div class="container article-shell">
            <nav class="breadcrumb-news" aria-label="Breadcrumb"><a href="<?= base_url(); ?>">Beranda</a><i class="fas fa-chevron-right small"></i><a href="<?= base_url('news'); ?>">Digital Pencak Silat News</a><i class="fas fa-chevron-right small"></i><span>Detail Berita</span></nav>
            <div class="article-heading"><span class="article-kicker"><i class="far fa-newspaper me-2"></i>Digital Pencak Silat News</span><h1 class="article-title"><?= html_escape($article['title']); ?></h1><?php if ($article['excerpt']): ?><p class="article-lead"><?= html_escape($article['excerpt']); ?></p><?php endif; ?><div class="article-meta"><span><i class="far fa-calendar-alt"></i><?= $article['published_at'] ? $format_date($article['published_at']) : 'Preview Draft'; ?></span><span><i class="far fa-user"></i><?= html_escape($article['author_name']); ?></span><span><i class="far fa-clock"></i><?= $reading_time; ?> menit membaca</span></div></div>
