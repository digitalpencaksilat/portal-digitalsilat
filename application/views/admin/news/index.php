...
<body class="admin-body">
    ...
    <script>
        ...
        $('.btn-delete-news').on('click', function(e) { e.preventDefault(); const href = $(this).attr('href'); Swal.fire({title:'Hapus berita ini?',text:'Data dan gambar berita akan dihapus permanen.',icon:'warning',showCancelButton:true,confirmButtonColor:'#C60000',cancelButtonColor:'#6c757d',confirmButtonText:'Ya, Hapus',cancelButtonText:'Batal'}).then(result => { if (result.isConfirmed) window.location.href = href; }); });
